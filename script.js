...
{
  //Splits the text into paragraphs, then reconstructs it without the final paragraph fragment
  ...
  //If the last paragraph fragment is of significant length, splits it into sentences and adds it to the return value without
  //the final sentence fragment
  if(stringPieces[stringPieces.length - 1].length >= approximateLineWdith * 1.5)
  {
